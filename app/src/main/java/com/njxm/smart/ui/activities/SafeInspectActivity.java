...
public class SafeInspectActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                com.njxm.smart.ui.activities.SafeInspectActivity.this.mData = com.njxm.smart.ui.activities.SafeInspectActivity.this.getData();
                SystemClock.sleep(2000);
                com.njxm.smart.ui.activities.SafeInspectActivity.this.updateView();
            }
        }).start();
    ...
    private void updateView() {
        this.invoke(new Runnable() {
            @Override
            public void run() {
                boolean hasData = com.njxm.smart.ui.activities.SafeInspectActivity.this.mData.size() > 0;
                com.njxm.smart.ui.activities.SafeInspectActivity.this.rlVoidData.setVisibility(hasData ? View.GONE : View.VISIBLE);
                com.njxm.smart.ui.activities.SafeInspectActivity.this.mRecyclerView.setVisibility(hasData ? View.VISIBLE : View.GONE);
                if (hasData) {
                    com.njxm.smart.ui.activities.SafeInspectActivity.this.mDailyCheckAdapter.setNewData(com.njxm.smart.ui.activities.SafeInspectActivity.this.mData);
                }
            }
        });
    }
