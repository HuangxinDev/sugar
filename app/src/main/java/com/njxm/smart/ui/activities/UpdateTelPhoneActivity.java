...
public class UpdateTelPhoneActivity extends BaseActivity implements View.OnClickListener {
    ...
    private final AppTextWatcher mAppTextWatcher = new AppTextWatcher() {
        ...
        public void afterTextChanged(String s) {
            if (StringUtils.isNotEmpty(com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mQRCode.getText()) && StringUtils.isNotEmpty(com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mNewPhoneNumberCode.getText())) {
                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mConfirmBtn.setEnabled(true);
                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mConfirmBtn.setText("确认");
            } else {
                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mConfirmBtn.setEnabled(false);
                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mConfirmBtn.setText("下一步");
            }
        }
    };
                ...
                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.timer.schedule(new TimerTask() {
                    ...
                    public void run() {
                        UpdateTelPhoneActivity.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mNewPhoneNumberCode.setRightText((com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.count--) + " 秒");
                                if (com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.count == 0) {
                                    cancel();
                                }
                            }
                        });
                    ...
                    public boolean cancel() {
                        com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.count = 60;
                        com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mNewPhoneNumberCode.getRightTextView().setEnabled(true);
                        com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mNewPhoneNumberCode.setRightText("重新获取");
                        return super.cancel();
                    }
                }, 0, 1000);
                if (com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.count == 60) {
                    HttpUtils.getInstance().request(new RequestEvent.Builder().url(UrlPath.PATH_SMS.getUrl())
                            ...
                            .addBodyJson("mobile", com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mBindPhoneEdit.getText().trim())
                            .addBodyJson("code", com.njxm.smart.ui.activities.UpdateTelPhoneActivity.this.mQRCode.getText().trim())
                            .build());
                }
            }
        });
            ...
            switch (com.njxm.smart.ui.activities.UpdateTelPhoneActivity.currentId) {
                case com.njxm.smart.ui.activities.UpdateTelPhoneActivity.ONE:
                    if (this.mBindPhoneEdit.getText().matches("1[0-9]{10}")) {
                        com.njxm.smart.ui.activities.UpdateTelPhoneActivity.currentId = com.njxm.smart.ui.activities.UpdateTelPhoneActivity.TWO;
