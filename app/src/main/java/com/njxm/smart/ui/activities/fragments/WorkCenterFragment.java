        ...
        api.getFeatureItems().enqueue(new Callback<ServerResponseBean<List<PermissionBean>>>() {
            ...
            public void onResponse(Call<ServerResponseBean<List<PermissionBean>>> call, Response<ServerResponseBean<List<PermissionBean>>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    com.njxm.smart.ui.activities.fragments.WorkCenterFragment.this.invoke(new Runnable() {
                        @Override
                        public void run() {
                            com.njxm.smart.ui.activities.fragments.WorkCenterFragment.this.mAdapter.setNewData(data);
                            com.njxm.smart.ui.activities.fragments.WorkCenterFragment.this.mAdapter.expandAll(0, true);
                        }
                    });
                }
            }
            ...
            public void onFailure(Call<ServerResponseBean<List<PermissionBean>>> call, Throwable t) {
                Log.e(com.njxm.smart.ui.activities.fragments.WorkCenterFragment.this.TAG, "request failed: " + Log.getStackTraceString(t));
            }
        });
    }
