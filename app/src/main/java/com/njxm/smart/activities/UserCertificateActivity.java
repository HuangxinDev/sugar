...
public class UserCertificateActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        com.njxm.smart.activities.UserCertificateActivity.refreshCertificateList();
        ...
        this.myCertificateAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                com.njxm.smart.activities.UserCertificateActivity.this.clickPosition = position;
                if (view.getId() == R.id.certificate_add) {
                    Intent intent = new Intent(UserCertificateActivity.this, CertificateTypeActivity.class);
                    com.njxm.smart.activities.UserCertificateActivity.this.startActivity(intent);
                } else if (view.getId() == R.id.certificate_image_show) {
                    com.njxm.smart.activities.UserCertificateActivity.this.takePhoto(100);
                }
            }
        });
                    ...
                    try {
                        Bitmap drawable =
                                Glide.with(UserCertificateActivity.this)
                                        .asBitmap().load(com.njxm.smart.activities.UserCertificateActivity.this.photoFile)
                                        .submit(ResolutionUtil.dp2Px(172), ResolutionUtil.dp2Px(109))
                                        .get();
                        BitmapUtils.saveBitmap(drawable, com.njxm.smart.activities.UserCertificateActivity.this.photoFile);
                        com.njxm.smart.activities.UserCertificateActivity.this.mCertificateItems.get(com.njxm.smart.activities.UserCertificateActivity.this.clickPosition).file = com.njxm.smart.activities.UserCertificateActivity.this.photoFile;
                        com.njxm.smart.activities.UserCertificateActivity.this.invoke(new Runnable() {
                            @Override
                            public void run() {
                                com.njxm.smart.activities.UserCertificateActivity.this.myCertificateAdapter.setNewData(com.njxm.smart.activities.UserCertificateActivity.this.mCertificateItems);
                            }
                        });
