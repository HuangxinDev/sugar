...
public class WorkCenterItemBean implements MultiItemEntity {

    public static final int ITEM_TITLE_TYPE = 658;
    public static final int ITEM_CONTENT_TYPE = 9;
    ...
    private List<WorkCenterItemBean> children;
    ...
    public List<WorkCenterItemBean> getChildren() {
        return children;
    }

    public void setChildren(List<WorkCenterItemBean> children) {
        this.children = children;
    }

    @Override
    public int getItemType() {
        return sr_level == 1 ? ITEM_TITLE_TYPE : ITEM_CONTENT_TYPE;
    }
}
